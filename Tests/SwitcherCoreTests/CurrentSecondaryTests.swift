...
final class CurrentSecondaryTests: XCTestCase {
    ...
    func testSecondaryVerifiedOwnership() {
        ...
        XCTAssertEqual(AccountStateResolver.secondary(receipt: receipt, currentStamp: stamp, paths: secondaryPaths, uid: 501,
    ...
    func testSecondaryPIDReuseOrWrongIdentityIsNeverOwned() {
        ...
        XCTAssertEqual(AccountStateResolver.secondary(receipt: receipt, currentStamp: reused, paths: secondaryPaths, uid: 501,
                                                      pending: false, launching: false, quitting: false, recordedPIDIsLive: true),
    ...
    func testSecondaryStaleReceiptBecomesStoppedWhenRecordedPIDIsGone() {
        let stamp = ProcessStamp(pid: 84, uid: 501, seconds: 100, microseconds: 1, executable: "/official")
        let receipt = LaunchReceipt(profile: .b, stamp: stamp, paths: secondaryPaths)
        XCTAssertEqual(AccountStateResolver.secondary(receipt: receipt, currentStamp: nil, paths: secondaryPaths, uid: 501,
                                                      pending: false, launching: false, quitting: false, recordedPIDIsLive: false), .stopped)
    }

    func testPendingSecondaryTakesPrecedenceAndBlocksOwnershipAssumptions() {
        XCTAssertEqual(AccountStateResolver.secondary(receipt: nil, currentStamp: nil, paths: secondaryPaths, uid: 501,
                                                      pending: true, launching: false, quitting: false, recordedPIDIsLive: false), .ownershipUncertain)
    }
    ...
    func testLegacyMetadataMigrationDropsAWithoutTouchingB() throws {
        ...
        let a = LaunchReceipt(profile: .a, stamp: ProcessStamp(pid: 1, uid: 501, seconds: 1, microseconds: 0, executable: "/official"), paths: aPaths)
        let b = LaunchReceipt(profile: .b, stamp: ProcessStamp(pid: 2, uid: 501, seconds: 2, microseconds: 0, executable: "/official"), paths: bPaths)
